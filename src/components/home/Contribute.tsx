import { Box, Button, Container, Heading, SimpleGrid, Stack, Text, Icon } from '@chakra-ui/react';
...
export const Contribute = () => {
  return (
    <Box as="section" pb={{ base: '4rem', md: '8rem' }} bgGradient="linear(to-b, #6983FF, #2054B2)">
      <Container maxW="7xl">
        <Stack spacing={12}>
          ...
          <SimpleGrid columns={{ base: 1, md: 3 }} spacing={8}>
            {contributeWays.map((way) => (
              ...
              >
                ...
                <Text textAlign={'left'} mb={'2'}>{way.description}</Text>
                {way.buttons && (
                  <Stack direction="row" spacing={4} mt={'auto'} width={'100%'} justifyContent={'flex-end'}>
